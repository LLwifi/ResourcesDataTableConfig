...
public:
	...
	UAudioComponent* PlaySound_2D(const UObject* WorldContextObject, AActor* Player, FName RowName, FString ResourceNameOrIndex, FGameplayTag SoundTag, FRDTC_PlaySoundSetting OverridePlaySoundSetting, bool IsUseParameter = true);
	
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", AdvancedDisplay = "6", DefaultToSelf = "Player"))
	UAudioComponent* PlaySound_Location(const UObject* WorldContextObject, AActor* Player, FName RowName, FString ResourceNameOrIndex, FGameplayTag SoundTag, FVector Location, FRDTC_PlaySoundSetting OverridePlaySoundSetting, bool IsUseParameter = true, FRotator Rotation = FRotator::ZeroRotator);

	UFUNCTION(BlueprintCallable, meta = (AdvancedDisplay = "5", DefaultToSelf = "Player"))
	UAudioComponent* PlaySound_Attached(AActor* Player, FName RowName, FString ResourceNameOrIndex, FGameplayTag SoundTag, USceneComponent* AttachToComponent, FRDTC_PlaySoundSetting OverridePlaySoundSetting, bool IsUseParameter = true, FName AttachPointName = NAME_None, FVector Location = FVector(ForceInit), FRotator Rotation = FRotator::ZeroRotator, EAttachLocation::Type LocationType = EAttachLocation::KeepRelativeOffset, bool bStopWhenAttachedToDestroyed = false);
	...
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", AdvancedDisplay = "5", DefaultToSelf = "Player"))
	TArray<UAudioComponent*> PlaySound_2D_Array(const UObject* WorldContextObject, AActor* Player, TArray<FResourceProperty_SoundAssetTag> SoundAssetTags, FGameplayTag SoundTag, FRDTC_PlaySoundSetting OverridePlaySoundSetting, bool IsRandomPlayOneSound = true, bool IsUseParameter = true);
	//IsRandomPlayOneSound : 是否随机播放一个声音，该值为flase时将尝试播放SoundAssetTags中的全部声音资产
	UFUNCTION(BlueprintCallable, meta = (WorldContext = "WorldContextObject", AdvancedDisplay = "6", DefaultToSelf = "Player"))
	TArray<UAudioComponent*> PlaySound_Location_Array(const UObject* WorldContextObject, AActor* Player, TArray<FResourceProperty_SoundAssetTag> SoundAssetTags, FGameplayTag SoundTag, FVector Location, FRDTC_PlaySoundSetting OverridePlaySoundSetting, bool IsRandomPlayOneSound = true, bool IsUseParameter = true, FRotator Rotation = FRotator::ZeroRotator);
	//IsRandomPlayOneSound : 是否随机播放一个声音，该值为flase时将尝试播放SoundAssetTags中的全部声音资产
	UFUNCTION(BlueprintCallable, meta = (AdvancedDisplay = "5", DefaultToSelf = "Player"))
	TArray<UAudioComponent*> PlaySound_Attached_Array(AActor* Player, TArray<FResourceProperty_SoundAssetTag> SoundAssetTags, FGameplayTag SoundTag, USceneComponent* AttachToComponent, FRDTC_PlaySoundSetting OverridePlaySoundSetting, bool IsRandomPlayOneSound = true, bool IsUseParameter = true, FName AttachPointName = NAME_None, FVector Location = FVector(ForceInit), FRotator Rotation = FRotator::ZeroRotator, EAttachLocation::Type LocationType = EAttachLocation::KeepRelativeOffset, bool bStopWhenAttachedToDestroyed = false);
